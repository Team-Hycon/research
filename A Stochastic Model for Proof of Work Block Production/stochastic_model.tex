...
We suggest that $\alpha$ be chosen such that the expected cost of acquiring $\xi$ influence by any one party be greater or equal to the cost of attacking the network via other means.  
